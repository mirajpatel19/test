  ...
  client.connect(function(err) {
    ...
    <br><strong>Comments: </strong>' + comments + '<br/>'
      ...
      app.post('/deleteOrder', function (req, res) {
        /* Handling the AngularJS post request*/
        console.log("Into deleteFunc on the.: ");
        console.log(req.body);
      ...
      app.post('/addOrder', function (req, res) {
        /* Handling the AngularJS post request*/
        console.log("Into addFunc on the.: ");
        console.log(req.body);
        ...
        //           VALUES($1, $2, $3, $4, $5, $6, $7)", [addOrder.userid, addOrder.saledate, addOrder.variety, addOrder.style, addOrder.size, addOrder.qty, addOrder.pounds], function(err, resu) {
        //     if (err) {
        //       throw err;
        //     }
        //   });
